...
bidReportsApp
    .controller('StockDemandController', function ($rootScope,
                                             $scope,
                                             $timeout,
                                             sqlViewService,
                                             userSettingsService,
...
//            data2.matrix[1] = [];
            ...
            for (var i = 0; i < $scope.template.length; i++) {
                ...
                if (data2.max < parseInt($scope.template[i].demand + $scope.template[i].demandOffset)) {
                    data2.max = parseInt($scope.template[i].demand + $scope.template[i].demandOffset);
                }
            ...
            data2.legendLabels = ["Demand "];
            data2.xAxisTitle = "Vaccines";
            data2.yAxisTitle = "Units";
            data2.chartTitle = "Stock Demand";
            d3.makeChart(data2, 400, 540);
        }
